...
class Replay:
    ...
    def get_data(self):
        ...
        self.ptr += 30 #for pi0 step is 30
        return data
...
if __name__ == "__main__":
    ...
    # 创建action收集器
    action_collector = ActionCollector(save_path="test/pick_place_cup/model_actions/", task_name="pi0_pick_place_cup")
    # 遍历每个hdf5文件进行测试
    for file_idx, source_hdf5_path in enumerate(hdf5_files):
        ...
        while step < max_step:
            ...
            for action in action_chunk:
                ...
                step += 1
                time.sleep(1/30)
                print(f"File {file_idx + 1}/{len(hdf5_files)}, Step {step}/{max_step} completed.")
